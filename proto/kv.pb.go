...
const file_proto_kv_proto_rawDesc = "" +
	"\n" +
	"\x0eproto/kv.proto\x12\x02kv\"K\n" +
	"\aPutArgs\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value\x12\x18\n" +
	"\aversion\x18\x03 \x01(\x04R\aversion\"\x1c\n" +
	"\bPutReply\x12\x10\n" +
	"\x03err\x18\x01 \x01(\tR\x03err\"\x1b\n" +
	"\aGetArgs\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\"L\n" +
	"\bGetReply\x12\x14\n" +
	"\x05value\x18\x01 \x01(\tR\x05value\x12\x18\n" +
	"\aversion\x18\x02 \x01(\x04R\aversion\x12\x10\n" +
	"\x03err\x18\x03 \x01(\tR\x03err2Q\n" +
	"\aKVStore\x12\"\n" +
	"\x03Put\x12\v.kv.PutArgs\x1a\f.kv.PutReply\"\x00\x12\"\n" +
	"\x03Get\x12\v.kv.GetArgs\x1a\f.kv.GetReply\"\x00B3Z1github.com/Ahmed-Saalah/distributed-raft-kv/protob\x06proto3"
...
var file_proto_kv_proto_goTypes = []any{
	(*PutArgs)(nil),  // 0: kv.PutArgs
	(*PutReply)(nil), // 1: kv.PutReply
	(*GetArgs)(nil),  // 2: kv.GetArgs
	(*GetReply)(nil), // 3: kv.GetReply
}
var file_proto_kv_proto_depIdxs = []int32{
	0, // 0: kv.KVStore.Put:input_type -> kv.PutArgs
	2, // 1: kv.KVStore.Get:input_type -> kv.GetArgs
	1, // 2: kv.KVStore.Put:output_type -> kv.PutReply
	3, // 3: kv.KVStore.Get:output_type -> kv.GetReply
